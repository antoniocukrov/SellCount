...
public class ZaprimiProzor extends javax.swing.JFrame {
    ...
    public ZaprimiProzor() {
        ...
        setTitle(SellCountUtil.getNaslov("Zaprimanje"));
        ucitaj();
        ucitajTablicu();
        ucitajDjelatnike();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtOtpremnica, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private void btnUnesiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUnesiActionPerformed
       if(listaSkladiste.getSelectedValue()==null){
        ...
        ms.addRow(vec);
        tblZaprimi.setModel(ms);
        artikliP.add((Artikl) listaSkladiste.getSelectedValue());
    ...
    private void btnPotvrdiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPotvrdiActionPerformed
        ...
        try {
            ...
            e.setDobavljac(txtDobavljac.getText());
